...
The recruitment task list for the ACM Student Chapter - Amritapuri

## Submission Deadline

### **2/10/2024** ( Will be open from 20th )
...
- _Google is going to be a very dear friend, not only for these tasks but throughout your career, so it's best to learn how to efficiently Google_
- _These tasks are for you to explore the wide world of Computer Science and not just a "Get it over with..." task list. Explore what areas capture your interest_
- _Don't try and cheat, for your own good, it just defeats the purpose_
- _We are always here to help you, just contact us. You might not get a direct answer, but you will absolutely be pointed in the right direction_
